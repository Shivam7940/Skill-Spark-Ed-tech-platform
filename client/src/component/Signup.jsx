    ...
    <div className="min-h-screen flex bg-[#0B1120]">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-[#0B1120] flex-col justify-between p-12">
        ...
        <div className="relative z-10 max-w-md">
          ...
          <p className="text-slate-400 text-base leading-relaxed">
            Join thousands of learners building real skills through hands-on courses, built by instructors who've shipped real products.
          </p>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-slate-950">
        <div className="w-full max-w-sm">
          ...
          <h2 className="text-2xl font-serif text-white mb-1">Create your account</h2>
          <p className="text-slate-400 text-sm mb-8">Start learning something new today.</p>
